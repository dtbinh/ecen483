function drawRodMass(u,L,w,R,H)
    ...
    if t==0,
        ...
        rod_handle  = drawRod(theta, L, w, [], 'normal');
        mass_handle = drawMass(theta, L, R, [], 'normal');
...
%=======================================================================
%
function handle = drawRod(theta, L, w, handle, mode)
...
%=======================================================================
%
function handle = drawMass(theta, L, R, handle, mode)
