...
function sys=mdlDerivatives(t,x,u,AP)
 ...
 thetaddot = (-2*AP.m1*y*ydot*thetadot-AP.m1*AP.g*y*cos(theta)...
     -AP.m2*AP.g*AP.L/2*cos(theta)+AP.L*F*cos(theta))/((AP.m2*AP.L^2)/3+AP.m1*y^2);
 %   thetaddot = 0;
  yddot     = (5/7*y*thetadot^2-5/7*AP.g*sin(theta));   
  
sys = [thetadot; ydot; thetaddot; yddot];
