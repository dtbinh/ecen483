function [sys,x0,str,ts,simStateCompliance] = ball_dynamics(t,x,u,flag,AP)
switch flag,
...
function sys=mdlDerivatives(t,x,u,AP)
  ...
  zddot = 5/7*z*thetadot^2 - 5/7*AP.g*stheta;
  thetaddot = (-2*AP.m1*z*zdot*thetadot - (AP.m2*AP.l/2 + AP.m1*z)*AP.g*ctheta+F*AP.l*ctheta)/(1/3*AP.m2*AP.l^2 + AP.m1*z^2);
