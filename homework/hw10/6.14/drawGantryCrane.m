function drawGantryCrane(u,bar,crane,L1,R1)
    ...
    if t==0,
        ...
        crane_handle = drawCrane(x, crane, [],'normal');
        rod1_handle = drawRod1(x, theta1, crane, L1, [],'normal');
        mass1_handle = drawMass1(x, theta1, crane, L1, R1, [],'normal');
        
        
    % at every other time step, redraw crane and loads
    else 
        drawCrane(x, crane, crane_handle);
        drawRod1(x, theta1, crane, L1, rod1_handle);
        drawMass1(x, theta1, crane, L1, R1, mass1_handle);
    end
end
...
%=======================================================================
%
function handle = drawCrane(x, crane, handle, mode)
...
%=======================================================================
%
function handle = drawRod1(x, theta1, crane, L1, handle, mode)
...
%=======================================================================
%
function handle = drawMass1(x, theta1, crane, L1, R1, handle, mode)
